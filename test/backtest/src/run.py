...
LAZY_HIGH_VOLATILE_WIDTH = list([48,56,64,72,80,88,96,104,112,128,144,160])
LAZY_EXTRA_VOLATILE_WIDTH = list([144,160,176,192,224,256,288,320,352,384,416,448])
...
if __name__ == "__main__":
    simulate(L.POOLS[L.INK_CHAIN_ID]['USDT_USDCe'], SIM.LAZY_SYNCING, LAZY_HIGH_VOLATILE_WIDTH)
    simulate(L.POOLS[L.INK_CHAIN_ID]['USDT_WETH'], SIM.LAZY_SYNCING, LAZY_EXTRA_VOLATILE_WIDTH)
    simulate(L.POOLS[L.INK_CHAIN_ID]['WETH_USDCe'], SIM.LAZY_SYNCING, LAZY_EXTRA_VOLATILE_WIDTH)

    #simulate(L.POOLS[L.INK_CHAIN_ID]['USDT_USDCe'], SIM.TAMPER_LOW, TAMPER_LOW_VOLATILE_WIDTH)

    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['ASTR_WETH'], SIM.LAZY_SYNCING, LAZY_EXTRA_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['WETH_USDCe'], SIM.LAZY_SYNCING, LAZY_HIGH_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['ASTR_nsASTR'], SIM.LAZY_SYNCING, LAZY_LOW_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['USDT_USDCe'], SIM.LAZY_SYNCING, LAZY_LOW_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['ASTR_nsASTR'], SIM.TAMPER_LOW, TAMPER_LOW_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.SONEIUM_CHAIN_ID]['USDT_USDCe'], SIM.TAMPER_LOW, TAMPER_LOW_VOLATILE_WIDTH)
    #simulate(L.POOLS[L.MODE_CHAIN_ID]['wMLT_USDC'], SIM.LAZY_SYNCING, LAZY_EXTRA_VOLATILE_WIDTH)
