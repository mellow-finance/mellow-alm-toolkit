...
contract PoolParameters {
    ...
    uint256 constant ONE_USD_ETH_AMOUNT = uint256(10 ** 18) / 2674; // 1 ETH/2800 ~ 1 USD
    ...
    uint256 constant ONE_USD_VELO_AMOUNT = uint256(100 * 10 ** 18) / 7; // 1 VELO ~ 0.0769 USD
    uint256 constant ONE_USD_BTC_AMOUNT_8 = uint256(10 ** 8) / 97900; // 1 BTC/97900 ~ 1 USD
    uint256 constant ONE_USD_BTC_AMOUNT_18 = uint256(10 ** 18) / 97900; // 1 BTC/97900 ~ 1 USD
    ...
    function _optimismPoolDeployParams(CoreDeployment memory contracts)
        ...
        returns (IVeloDeployFactory.DeployParams[] memory poolDeployParams)
    {
        poolDeployParams = new IVeloDeployFactory.DeployParams[](12);
        /*
            --------------------------------------------------------------------------------------------------|
        ...
        returns (IVeloDeployFactory.DeployParams[] memory poolDeployParams)
    {
        ...
        /*
            [0]   0x3Adf15f77F2911f84b0FE9DbdfF43ef60D40012c | 8000 | 100 |  weth  |  usdc  | 100k | lazySync |   6000   | 1 hour | 60   |
            [2]   0xc2026f3fb6fc51F4EcAE40a88b4509cB6C143ed4 | 8000 | 100 |  weth  |  xvelo |  15k | lazySync |  19200   | 1 hour | 192  |
            [3]   0x9c92aA1d12dE024E219884e133B58895C27d6610 | 8000 | 100 |  usdc  |  usdt  |  15k | lazySync |   24     | 1 hour | 1    |
            [1]   0x1E41CDE26b30646bb3DBBea48A63708b00470c1c | 8000 | 100 |  weth  |  mode  |  50k | lazySync |  25600   | 1 hour | 250  |
        weth 3
        usdc 2
        mode, xvelo, usdt - 1
        */
