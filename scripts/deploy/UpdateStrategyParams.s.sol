...
contract UpdateStrategyParams is Test {
    ...
    */
    function run() external {
        vm.startPrank(ADMIN);
        getStrategyParams(0xcd975e6a5F55137755487F0918b8ca74aCCe7925, 700, 60); // 0xb2cc224c1c9feE385f8ad6a55b4d94E92359DC59 WETH / USDC
        getStrategyParams(0xB9DB6804e84D960E139A2BdC33bfC30f8fb689Fe, 800, 60); // 0x70aCDF2Ad0bf2402C957154f944c19Ef4e1cbAE1 WETH / cbBTC
        getStrategyParams(0x0Df5f2662e4a8C801c04D83Df717476509816250, 700, 60); // 0x4e962BB3889Bf030368F56810A9c96B83CB3E778 USDC / cbBTC
        getStrategyParams(0xf7511B7433241A2873e089965578FF34b3eceb84, 2, 2); // 0xc5E51044eB7318950B1aFb044FccFb25782C48c1 EURC / USDC
        getStrategyParams(0x33DB29651B30C09c0a9184893215905E5F536130, 2, 2); // 0xa41Bc0AFfbA7Fd420d186b84899d7ab2aC57fcD1 USDC / USDT
        vm.stopPrank();
    }

    function getStrategyParams(address lpWrapper, int24 width, int24 maxAllowedDelta) internal {
        ...
        IVeloOracle.SecurityParams memory securityParams =
            abi.decode(positionInfo.securityParams, (IVeloOracle.SecurityParams));
        ...
        /// @dev update maxAllowedDelta and maxAge in security params
        securityParams.maxAllowedDelta = maxAllowedDelta;
        securityParams.maxAge = 15 minutes;
        ...
        assertEq(
            maxAllowedDelta,
            abi.decode(positionInfo.securityParams, (IVeloOracle.SecurityParams)).maxAllowedDelta
        );
        assertEq(
            15 minutes, abi.decode(positionInfo.securityParams, (IVeloOracle.SecurityParams)).maxAge
        );
