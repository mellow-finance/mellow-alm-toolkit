...
library Constants {
    ...
    address internal constant SUPERSEED_MELLOW_ADMIN = address(0); // actual mellow msig
    ...
    address internal constant SUPERSEED_LP_WRAPPER_MANAGER = address(0); // msig Velo+Mellow
