...
contract Compounder is DefaultAccessControl {
    ...
    function compound(IVeloDeployFactory factory, address[] memory pools) external {
        ...
        for (uint256 i = 0; i < pools.length; i++) {
            ...
            if (timestamp < farm.periodFinish()) {
                continue;
            }
            ...
            ICounter counter =
                ICounter(abi.decode(params_, (IVeloAmmModule.CallbackParams)).counter);
