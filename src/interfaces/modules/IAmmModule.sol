...
interface IAmmModule {
     ...
     */
    function validateProtocolParams(ProtocolParams memory params) external view;

    /**
     * @dev Validates callback parameters.
     * @param params The callback parameters to be validated.
     */
    function validateCallbackParams(CallbackParams memory params) external view;
     ...
     * @param sqrtRatioX96 Square root of the current price value in the pool.
